...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Tandoori (Leg Qtr)", price: "$7.99", image: "/images/chi_tan.jpeg" },
      ...
      { name: "Chicken Tikka Boti", price: "$12.99", image: "/images/chi_ti.jpeg" },
      { name: "Mix Grill Platter", price: "$32.99", image: "/images/mix_gri_pla.jpeg" },
    ],
  },
  {
    id: "haleem",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Egg Biryani", price: "$13.99", image: "/images/egg_bir.jpg" },
      { name: "Hyderabadi Chicken Dum Biryani", price: "$14.99", image: "/images/hyd_chi_dum_bri.jpeg" },
      ...
      { name: "Hyderabadi Goat Dum Biryani", price: "$18.99", image: "/images/hyd_goat_du_bir.jpeg" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Andhra Chicken Curry", price: "$14.99", image: "/images/andra_chi.jpg" },
      { name: "Kadai Chicken", price: "$14.99", image: "/images/kadai_chi.jpg" },
      { name: "Dum Ka Chicken", price: "$16.99", image: "/images/dumka_chi.jpg" },
